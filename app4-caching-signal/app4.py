"""
Install redis docker image  [https://markheath.net/post/exploring-redis-with-docker]
Install redis-py from anaconda into conda env [https://stackoverflow.com/questions/55483235/redis-installation-using-conda-not-working-modulenotfounderror-no-module-named]
Find parameters for redis using 
# import redis
# r=redis.Redis()
# print(r)
